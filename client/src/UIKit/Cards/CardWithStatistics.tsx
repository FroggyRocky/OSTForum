...
import {CardStatisticsPanel} from "../CardStatisticsPanel/CardStatisticsPanel";
...
export const CardWithStatistics = (props: Props) => {
    ...
    return <StyledCard>
        ...
        <StyledFlex style={{padding: '30px'}} flexWrap='nowrap' flexDirection='column' alignItems='start'
            ...
            <StyledFlex justifyContent='space-between' style={{width: '100%'}}>
                ...
                <CardStatisticsPanel withRepost views={props.views} comments={props.comments} likes={props.likes}
