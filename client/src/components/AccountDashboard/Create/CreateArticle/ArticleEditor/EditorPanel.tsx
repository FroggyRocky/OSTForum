...
export const EditorPanel = (props: Props) => {
    ...
    return <>
        <StyledFlex style={{marginBottom: '30px'}} justifyContent={'space-between'}>
            <StyledFlex gap={'30px'}>
                {headers}
            ...
            <StyledFlex gap={'30px'}>
                ...
                <CategoryContainer ref={categoryFlagsRef}>
                    <Button onClick={() => setCategoryDropDownState(prev => !prev)}>
                        <StyledFlex style={{cursor: 'pointer'}}>
                            <BsFillBookmarkFill/>
                            <MdArrowDropDown/>
                        </StyledFlex>
                    </Button>
                    <CategoryDropDown setValue={chooseCategory} setTouched={setCategoryDropDownState} currentValue={categoryFormValue}
