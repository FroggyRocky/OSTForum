...
import {StyledContent, StyledH1} from "../../../../UIKit/BasicStyledComponents/basicStyledComponents";
...
import {
    ...
    StyledAddImgWithOutTextBtn,
    StyledAddImgWithTextBtn,
    StyledArticleEditorContainer,
    StyledBreakingLine,
    StyledCoversContainer,
    StyledErrorMessage,
    StyledFormContent
} from '../../../../UIKit/Form/StyledComponents'
import {CustomTextAreaWithCounter} from "../../../../UIKit/Form/Inputs/CustomTextAreaWithCounter";
import {CustomInputWithCounter} from "../../../../UIKit/Form/Inputs/CustomInputWithCounter";
...
export function CreateArticle(props: Props) {
    ...
    return <form onSubmit={formik.handleSubmit}>
        ...
        <StyledContent style={{padding: '60px 0'}}>
            ...
            <StyledH1 style={{textAlign: 'center'}}>Add new articles</StyledH1>
            <StyledFormContent>
                ...
                <StyledCoversContainer>
                    <label htmlFor="uploadWithText">
                        <StyledAddImgWithTextBtn onDragEnter={dragEnter} onDrop={imgDrop} onDragOver={dragOver}
                    ...
                    <label htmlFor="uploadWithOutText">
                        <StyledAddImgWithOutTextBtn onDragEnter={dragEnter} onDrop={imgDrop} onDragOver={dragOver}
        ...
        <StyledContent>
            <StyledArticleEditorContainer>
                ...
                {formik.errors.text && <StyledErrorMessage style={{marginTop: '30px'}}>{formik.errors.text}</StyledErrorMessage>}
            </StyledArticleEditorContainer>
            <StyledAddArticleButtonContainer>
                ...
                {!formik.isValid &&
                    <StyledErrorMessage style={{marginTop: '30px'}}>You haven't passed validation, check if all the fields are
